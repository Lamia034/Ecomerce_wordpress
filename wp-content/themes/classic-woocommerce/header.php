      ...
      <div class="col-lg-3 col-md-4 col-sm-12">
        ...
        <?php classic_ecommerce_the_custom_logo(); ?>
          <div class="site-branding-text">
            ...
            <?php } ?>
            <?php $classic_ecommerce_description = get_bloginfo( 'description', 'display' );
            if ( $classic_ecommerce_description || is_customize_preview() ) : ?>
              <?php if ( get_theme_mod('classic_ecommerce_tagline_enable',false) != "") { ?>
              <span class="site-description primary-color"><?php echo esc_html( $classic_ecommerce_description ); ?></span>
              <?php } ?>
            <?php endif; ?>
          </div>
        </div>
